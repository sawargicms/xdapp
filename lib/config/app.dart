...
class Config {
  ...
  /// Generated by SiteNative 21-06-2022 15:56:51
  ...
  static List<NavigationItem> mainNavigation = [
	...
	NavigationItem(name: "Layanan",icon: "ellipsis-horizontal.svg",type: ActionType.internal,value: "https://wnr.app/webview",),
  ...
  static List<NavigationItem> modalNavigation = [
	...
	NavigationItem(name: "Paket Up",icon: "rocket.svg",type: ActionType.internal,value: "https://wnr.app/user/plans#plans",),
	NavigationItem(name: "Faq",icon: "bookmark.svg",type: ActionType.internal,value: "https://wnr.app/faq",),
	NavigationItem(name: "Kirim Mail",icon: "mail-unread.svg",type: ActionType.email,value: "halo@wnr.app",),
