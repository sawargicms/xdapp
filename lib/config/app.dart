...
class Config {
  /// Generated by SiteNative 23-06-2022 17:12:30
  ...
  static List<String> cssHideBlock = [
    ".navbar navbar-expand-md navbar-dark d-print-none",".navbar navbar-expand-md navbar-light d-print-none",
  ];
  ...
  static List<NavigationItem> mainNavigation = [
	...
	NavigationItem(name: "Photo",icon: "duplicate.svg",type: ActionType.internal,value: "https://wnr.app/user/add-media",),
	NavigationItem(name: "Toko Wa",icon: "storefront-outline.svg",type: ActionType.internal,value: "https://wnr.app/user/create-store",),
