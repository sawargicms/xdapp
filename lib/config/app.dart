...
class Config {
  /// Generated by SiteNative 22-06-2022 11:48:04
  ...
  /// *** App config *** ///
  // App name
  static String appName = "Wshop Tes";
  // App link
  ...
  static String color = "#250181";
  // Active color (any HEX color)
  static String activeColor = "#3E063F";
  // Icon color color (any HEX color)
  static String iconColor = "#850C88";
  ...
  static String indicatorColor = "#F02EF4";
  ...
  static List<NavigationItem> mainNavigation = [
	...
	NavigationItem(name: "shop",icon: "bag-check.svg",type: ActionType.internal,value: "https://wnr.app",),
