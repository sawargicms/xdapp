...
class Config {
  /// Generated by SiteNative 22-06-2022 16:48:30
  ...
  /// *** App config *** ///
  // App name
  static String appName = "Point Of Sale swgcms";
  // App link
  ...
  // Background color (any HEX color)
  static String splashBackgroundColor = "#4A34FF";
  ...
  // Tagline
  static String splashTagline = "Point Of Sale | Khusus Karyawan Sawargi";
